...
CREATE TABLE IF NOT EXISTS `flow` (
    ...
    `result` INT(11) NOT NULL DEFAULT '0' COMMENT 'Workflow  result: 0=no result, 1=APPROVED, 2=REJECTED',
...
CREATE TABLE IF NOT EXISTS `node` (
    ...
    `type` INT NOT NULL DEFAULT 0 COMMENT 'Type of node: 0=data, 1=control',
